...
# hardcode the screen size (width and height)
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 500

# colors variables used for the game
BLACK = (0,0,0)
WHITE = (255,255,255)
GREEN = (0,255,0)
RED = (255,0,0)
...
class Menu(object):
	...
	def __init__(self,items,font_color=(15,160,245),select_color=(245,99,15),ttf_font=None,font_size=25):
		...
		self.items = items
		self.font = pygame.font.Font('depend/kids3.ttf',font_size)
...
class Game(object):
	def __init__(self):
		...
		self.score_font = pygame.font.Font('depend/kids3.ttf',20)
		...
		self.menu = Menu(items,ttf_font="depend/kids3.ttf",font_size=80)
		# True: show menu
		self.show_menu = True
		...
		self.background_image = pygame.image.load("depend/bg2.jpg").convert()

		
		pygame.display.update()
		# load sounds effects
		self.sound_1 = pygame.mixer.Sound("depend/message.ogg")
		self.sound_2 = pygame.mixer.Sound("depend/wrong_answer.wav")
		self.sound_3 = pygame.mixer.Sound("depend/appear-online.ogg")
	...
	def get_symbols(self):
		...
		symbols = {}
		sprite_sheet = pygame.image.load("depend/symbols2.png").convert()
	...
	def display_message(self,screen,items):
		...
		for index, message in enumerate(items):
			label = self.font.render(message,True,ORANGE)
	...
	def display_frame(self,screen):
		# Draw the background image and update the screen.
		screen.blit(self.background_image,(0,0))										#################################### 										
		self.background_image = pygame.image.load("depend/bg3.jpg").convert()			## added 10/26
		screen.blit(self.background_image,(0,0))
																						####################################
		...
		if self.show_menu:
			...
			self.score = 0
			self.count = 0
			# set time_wait True to wait 5 seconds
			time_wait = True
		else:
		...
		# creates a var myfont for the main title																													
		myfont = pygame.font.Font('depend/kids3.ttf',80)
		# creates a var myfont2 for the exit button
		myfont2 = pygame.font.Font('depend/kids3.ttf',50)
		# creates and renders a var textsurface and adds the main title using myfont
		textsurface = myfont.render('MATH ADVENTURES', False, (YELLOW))
		# creates and rendes a var textsurface2 and adds the "X" (exit button) on the screen
		textsurface2 = myfont2.render('X', False, (RED))
		# sets the onscrenn coordinates of the main title 
		screen.blit(textsurface, (110, 10))
		# sets the onscreen coordinates of the "x" button
		...
		if self.reset_problem:
			...
			# wait five seconds while displaying the final score. 
...
class Button(object):
	def __init__(self,x,y,width,height,number):
		...
		self.font = pygame.font.Font('depend/kids3.ttf',60)
...
def main():
	...
	pygame.mixer.music.load('depend/game_theme.ogg')
