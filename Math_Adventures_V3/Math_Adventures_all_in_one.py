...
class Game(object):
	def __init__(self):
		...
		self.background_image = pygame.image.load("images/bg2.jpg").convert()

		
		pygame.display.update()
		# load sounds effects
		self.sound_1 = pygame.mixer.Sound("sounds/message.ogg")
		self.sound_2 = pygame.mixer.Sound("sounds/wrong_answer.wav")
		self.sound_3 = pygame.mixer.Sound("sounds/appear-online.ogg")
	...
	def get_symbols(self):
		...
		symbols = {}
		sprite_sheet = pygame.image.load("images/symbols2.png").convert()
	...
	def display_frame(self,screen):
		...
		self.background_image = pygame.image.load("images/bg3.jpg").convert()			## added 10/26
		screen.blit(self.background_image,(0,0))
																						####################################
