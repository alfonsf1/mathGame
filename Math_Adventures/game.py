...
class Game(object):
	def __init__(self):
		...
		self.score_font = pygame.font.Font("kids3.ttf",20)
		...
		self.menu = Menu(items,ttf_font="kids3.ttf",font_size=80)
		# True: show menu
		self.show_menu = True
		...
		self.background_image = pygame.image.load("bg.jpg").convert()
		# load sounds effects
		self.sound_1 = pygame.mixer.Sound("right_answer.mp3")
		self.sound_2 = pygame.mixer.Sound("wrong_answer.mp3")
